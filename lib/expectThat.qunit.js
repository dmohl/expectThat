...
(function(expectThat, qunit, exports) {
  expectThat.api.qunit = {
    assertProvider: function(actual) {
      this.actual = actual;
    },
    isEqualTo: function(expected) {
      return qunit.equal(this.actual, expected);
    },
    isNotEqualTo: function(expected) {
      return qunit.notEqual(this.actual, expected);
    },
    isTrue: function() {
      return qunit.ok(this.actual);
    },
    isFalse: function() {
      return qunit.ok(!this.actual);
    },
    throwException: function(message) {
      if (typeof message !== "undefined" && message !== null) {
        return qunit.raises(this.actual, message);
      } else {
        return qunit.raises(this.actual);
      }
    },
    expectThat: function(fn) {
      var testDescription;
      testDescription = this.extendApi(fn, assertProvider);
      return qunit.testpavlov.api.it(testDescription, fn);
    }
  };
  expectThat.util.extend(expectThat, expectThat.api.qunit);
  return exports.expectThat = expectThat;
})(expectThat || (expectThat = {}), window, window);